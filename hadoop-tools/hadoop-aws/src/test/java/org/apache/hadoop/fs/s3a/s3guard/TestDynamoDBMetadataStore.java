...
public class TestDynamoDBMetadataStore extends MetadataStoreTestBase {
  ...
  private DynamoDBMSContract createContract(String tableName) throws
      IOException {
  ...
  public void testCreateExistingTable() throws IOException {
    final DynamoDBMetadataStore ddbms =
        createContract(BUCKET).getMetadataStore();
  ...
  public void testProvisionTable() throws IOException {
    final DynamoDBMetadataStore ddbms = createContract(BUCKET)
        .getMetadataStore();
