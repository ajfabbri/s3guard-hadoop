...
public class TestDynamoDBMetadataStore extends MetadataStoreTestBase {
  ...
  private static class DynamoDBMSContract extends AbstractMSContract {
    ...
    DynamoDBMSContract() throws IOException {
      ...
      conf.setClass(Constants.S3_CLIENT_FACTORY_IMPL, MockS3ClientFactory.class,
   ...
   */
  @Test
  public void testInitializeWithFileSystem() throws IOException {
    ...
    try (DynamoDBMetadataStore ddbms = new DynamoDBMetadataStore()) {
      ...
      assertEquals("DynamoDB table should be in the same region as S3 bucket",
          s3afs.getAmazonS3Client().getRegion().toAWSRegion(),
          ddbms.getRegion());
    }
  }

  @Test
  public void testCreatExistingTable() throws IOException {
