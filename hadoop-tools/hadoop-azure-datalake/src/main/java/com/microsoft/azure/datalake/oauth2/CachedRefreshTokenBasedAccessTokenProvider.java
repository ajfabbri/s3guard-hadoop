...
package com.microsoft.azure.datalake.oauth2;
...
/**
 * Extension to AccessTokenProvider to maintain token information per process level. Share access token across multiple
 * instances of AdlFileSystem, Allows performance improvment since multiple AAD calls are avoided within the process.
 */
public final class CachedRefreshTokenBasedAccessTokenProvider extends PrivateCachedRefreshTokenBasedAccessTokenProvider {
    ...
    /**
     * Gets the access token from internally cached ConfRefreshTokenBasedAccessTokenProvider instance.
     *
