...
public class Adl extends DelegateToFileSystem {
    ...
    Adl(URI theUri, Configuration conf)
            throws IOException, URISyntaxException {
        super(theUri, createDataLakeFileSystem(conf), conf,
                AdlFileSystem.SCHEME, false);
    }

    private static AdlFileSystem createDataLakeFileSystem(
            Configuration conf) {
