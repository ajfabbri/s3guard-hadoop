...
public final class ADLConfKeys {
  ...
  public static final String LOG_VERSION = "1.2.1";
  ...
  static final String ADL_FEATURE_CACHE_FILE_STATUS =
      "adl.feature.override.cache.filestatus";
  static final boolean ADL_FEATURE_CACHE_FILE_STATUS_DEFAULT = true;
  static final String ADL_FEATURE_CACHE_FILE_STATUS_DURATION =
      "adl.feature.override.cache.filestatus.duration";
  static final int ADL_FEATURE_CACHE_FILE_STATUS_DURATION_DEFAULT =
  ...
  static final String ADL_DEBUG_OVERRIDE_ENABLE_PERF_LOG =
      "adl.debug.override.enable.performance.log";
  static final String ADL_DEBUG_OVERRIDE_ENABLE_DEBUG_LOG =
      "adl.debug.override.enable.debug.log";
