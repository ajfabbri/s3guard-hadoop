...
/**
 * Create ADL filesystem delegation with Swebhdfs scheme. Intent to use by AdlFileSystem only.
 */
public class PrivateAzureDataLake extends DelegateToFileSystem {
    ...
    private static PrivateAzureDataLakeFileSystem createPrivateAzureDataLakeFileSystem(
            Configuration conf) {
        PrivateAzureDataLakeFileSystem fs = new PrivateAzureDataLakeFileSystem();
        fs.setConf(conf);
        return fs;
    }
