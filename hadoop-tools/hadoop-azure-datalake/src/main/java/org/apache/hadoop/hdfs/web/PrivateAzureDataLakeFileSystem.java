...
public class PrivateAzureDataLakeFileSystem extends SWebHdfsFileSystem {
   ...
   * Threads need to be daemon so that they don't prevent the process from
   * exiting
   */
   ...
   * @param srcs List of sources to be concatenated. ADL concatenate in the
  ...
  private String getADLEnabledFeatureSet() {
    // TODO : Implement current feature set enabled for the instance.
