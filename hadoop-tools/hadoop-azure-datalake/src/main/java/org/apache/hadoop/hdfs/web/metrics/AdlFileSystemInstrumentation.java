...
package org.apache.hadoop.hdfs.web.metrics;
...
public class AdlFileSystemInstrumentation implements MetricsSource {
  ...
  public static final String ADL_BYTES_WRITTEN =
      "adl_bytes_written_last_second";
  ...
  public static final String ADL_RAW_BYTES_DOWNLOADED =
      "adl_raw_bytes_downloaded";
  ...
  public static final String ADL_DIRECTORIES_CREATED =
      "adl_directories_created";
  public static final String ADL_DIRECTORIES_DELETED =
      "adl_directories_deleted";
  public static final String ADL_UPLOAD_RATE =
      "adl_maximum_upload_bytes_per_second";
  public static final String ADL_DOWNLOAD_RATE =
      "adl_maximum_download_bytes_per_second";
  public static final String ADL_UPLOAD_LATENCY =
      "adl_average_block_upload_latency_ms";
  public static final String ADL_DOWNLOAD_LATENCY =
      "adl_average_block_download_latency_ms";
  ...
  private final MetricsRegistry registry = new MetricsRegistry("adlFileSystem")
      .setContext("adlFileSystem");
  private final MutableCounterLong numberOfWebResponses = registry
      .newCounter(ADL_WEB_RESPONSES,
          "Total number of web responses " + "obtained from ADL", 0L);
  private final MutableCounterLong numberOfFilesCreated = registry
      .newCounter(ADL_FILES_CREATED,
          "Total number of files created " + "through the ADL file system.",
          0L);
  private final MutableCounterLong numberOfFilesDeleted = registry
      .newCounter(ADL_FILES_DELETED,
          "Total number of files deleted " + "through the ADL file system.",
          0L);
  private final MutableCounterLong numberOfDirectoriesCreated = registry
      .newCounter(ADL_DIRECTORIES_CREATED,
          "Total number of directories created through the ADL file system.",
          0L);
  private final MutableCounterLong numberOfDirectoriesDeleted = registry
      .newCounter(ADL_DIRECTORIES_DELETED,
          "Total number of directories deleted through the ADL file system.",
          0L);
  private final MutableGaugeLong bytesWrittenInLastSecond = registry
      .newGauge(ADL_BYTES_WRITTEN,
          "Total number of bytes written to ADL during the last second.", 0L);
  private final MutableGaugeLong bytesReadInLastSecond = registry
      .newGauge(ADL_BYTES_READ,
          "Total number of bytes read from ADL during the last second.", 0L);
  private final MutableGaugeLong maximumUploadBytesPerSecond = registry
      .newGauge(ADL_UPLOAD_RATE,
          "The maximum upload rate encountered to ADL in bytes/second.", 0L);
  private final MutableGaugeLong maximumDownloadBytesPerSecond = registry
      .newGauge(ADL_DOWNLOAD_RATE,
          "The maximum download rate encountered to ADL in bytes/second.", 0L);
  private final MutableCounterLong rawBytesUploaded = registry
      .newCounter(ADL_RAW_BYTES_UPLOADED,
          "Total number of raw bytes (including overhead) uploaded to Azure"
              + " Storage.", 0L);
  private final MutableCounterLong rawBytesDownloaded = registry
      .newCounter(ADL_RAW_BYTES_DOWNLOADED,
          "Total number of raw bytes (including overhead) downloaded from " +
              "Azure" + " Storage.", 0L);
  private final MutableCounterLong clientErrors = registry
      .newCounter(ADL_CLIENT_ERRORS,
          "Total number of client-side errors by ADL (excluding 404).", 0L);
  private final MutableCounterLong serverErrors = registry
      .newCounter(ADL_SERVER_ERRORS,
          "Total number of server-caused " + "errors by ADL.", 0L);
