...
/**
 * Extended Webhdfs PostOpParam to avoid redirect during append operation for azure data lake storage.
 */

public class ADLPostOpParam extends HttpOpParam<ADLPostOpParam.Op> {
    private static final Domain<Op> DOMAIN = new Domain<ADLPostOpParam.Op>(NAME, Op.class);
    ...
    public static enum Op implements HttpOpParam.Op {
        ...
        Op(final boolean doOut, final boolean doRedirect, final int expectHttpResponseCode) {
            this.doOutput = doOut;
