...
/**
 * To support single writer semantics. Notify to ADL backend if the stream needs to locked in order to protect concurrent write opetation on the same stream.
 * <p>
